                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6 d-flex flex-column justify-content-center p-3">
                        ...
                        <ul>
                            <li>
                                <p>
                                    <strong>Destinazioni Interplanetarie:</strong> Da Marte a Europa (la luna di Giove),
                                    BoolXTravel ti porta nei luoghi più emozionanti del sistema solare. Immagina passeggiare
                                    sulla superficie di Marte o ammirare i geyser di Europa!
                                </p>
                            </li>
                            <li>
                                <p>
                                    <strong>Viaggi Stellari:</strong> Siamo i pionieri dei viaggi interstellari. Attraverso
                                    wormhole e warp drive, ti portiamo verso stelle lontane e pianeti alieni. Preparati a
                                    vedere sistemi solari completamente diversi dal nostro.
                                </p>
                            </li>
                            <li>
                                <p>
                                    <strong>Hotel Galattici:</strong> I nostri hotel spaziali offrono viste mozzafiato su
                                    pianeti, stelle e galassie. Svegliati con un’alba su Alpha Centauri o goditi un tramonto
                                    su un pianeta gassoso.
                                </p>
                            </li>
                            <li>
                                <p>
                                    <strong>Esperienze Extraterrestri:</strong> Vuoi incontrare gli alieni? Organizziamo
                                    tour verso pianeti abitati da forme di vita aliene. Non preoccuparti, abbiamo traduttori
                                    universali per comunicare con loro!
                                </p>
                            </li>
                        </ul>
                    </div>
